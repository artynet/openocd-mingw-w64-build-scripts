...
# renaming folder
mv ${OPENOCD_INSTALL_FOLDER} ${OPENOCD_WORKING_FOLDER}/OpenOCD-0.10.x

cd ${OPENOCD_WORKING_FOLDER}

tar cfvj OpenOCD-0.10.x.org-win${TARGET_BITS}-${stag}.tar.bz2 OpenOCD-0.10.x/

# Removing build folder
rm -rf ${OPENOCD_WORKING_FOLDER}/OpenOCD-0.10.x
